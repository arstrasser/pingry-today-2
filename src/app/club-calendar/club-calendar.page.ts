...
import { FeedParseProvider } from '../feed-parse.service';
import { MessagesProvider } from '../messages.service';
import { DateFunctionsProvider } from '../../providers/date-functions/date-functions';


@Component({
  selector: 'app-club-calendar',
  templateUrl: './club-calendar.page.html',
  styleUrls: ['./club-calendar.page.scss'],
})
export class ClubCalendarPage implements OnInit {
  events:Array<any> = [];
    l:any;
